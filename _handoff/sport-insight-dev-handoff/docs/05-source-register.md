...
### [T01] OpenAI — Codex AGENTS.md
`https://developers.openai.com/codex/guides/agents-md`

Codex의 프로젝트 지침 파일과 경로별 지침 처리에 관한 공식 안내. 공통 규칙은 저장소 루트 AGENTS.md에 둔다.

### [T02] Anthropic — Claude Code memory / CLAUDE.md
`https://code.claude.com/docs/en/memory`

Claude Code는 CLAUDE.md를 읽으며 @AGENTS.md import 방식으로 공통 지침을 공유할 수 있다. 기존 지침은 덮어쓰지 않는다.
